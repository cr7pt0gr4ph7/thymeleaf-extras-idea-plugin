...
public class HbTokenTypes {
    ...
    public static final IElementType BLOCK_WRAPPER = new HbCompositeElementType("BLOCK_WRAPPER"); // used to delineate blocks in the PSI tree. The formatter requires this extra structure.
