package org.thymeleaf.extras.idea.editor.folding;
...
public class HbFoldingBuilder implements FoldingBuilder, DumbAware {
    ...
    /**
     * If the given element is a {@link org.thymeleaf.extras.idea.psi.HbOpenBlockMustache} returns the close 'stache node ("}}")
     * <p>
    ...
    /**
     * If the given element is a {@link org.thymeleaf.extras.idea.psi.HbCloseBlockMustache}, returns the close 'stache node ("}}")
     * <p>
     * Otherwise, returns null
     */
