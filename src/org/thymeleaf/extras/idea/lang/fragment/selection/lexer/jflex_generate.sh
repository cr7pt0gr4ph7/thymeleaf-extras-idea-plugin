...
####
# Run this script to regenerate _FragmentSelectorLexer.java from _FragmentSelector.flex
####
...
${IDEA_SRC_ROOT}/tools/lexer/jflex-1.4/bin/jflex --charat --nobak --skel \
  ${IDEA_SRC_ROOT}/tools/lexer/idea-flex.skeleton -d . --verbose _FragmentSelector.flex \
