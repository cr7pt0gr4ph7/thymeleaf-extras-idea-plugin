...
public class EqExprImpl extends FakeBinaryExpressionImpl implements EqExpr {

  public EqExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitEqExpr(this);
