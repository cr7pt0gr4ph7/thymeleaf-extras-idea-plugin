...
public class OrExprImpl extends FakeBinaryExpressionImpl implements OrExpr {

  public OrExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitOrExpr(this);
