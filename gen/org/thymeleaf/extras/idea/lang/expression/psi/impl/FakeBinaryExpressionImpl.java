...
public class FakeBinaryExpressionImpl extends ExpressionImpl implements FakeBinaryExpression {

  public FakeBinaryExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitFakeBinaryExpression(this);
