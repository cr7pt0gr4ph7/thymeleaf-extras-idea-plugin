...
import org.thymeleaf.extras.idea.util.HbTestUtils;
...
public class HbFoldingBuilderTest extends LightPlatformCodeInsightFixtureTestCase {
    ...
    public void testFoldsWithUnclosedBlocks() { doTest(); }
    public void testMultiLineOpenStacheFolds() { doTest(); }
    ...
    public void testInverseBlockCodeFolds() { doTest(); }
